...
int AMRStructure::evaluate_vorticity_grad(std::vector<double>& vorticity_laplacian_local, std::vector<double>& vorticity_none_local, 
                    std::vector<double>& xs_local,std::vector<double>& ys_local,
                        std::vector<double>& ws_local, double t) {
    std::vector<double> xtemp_cpy(xs_local), ytemp_cpy(ys_local);
    std::vector<double> ws_temp_cpy(ws_local);
...
int AMRStructure::evaluate_vorticity_grad(std::vector<double>& j_laplacian_local, std::vector<double>& j_none_local, 
                    std::vector<double>& xs_local,std::vector<double>& ys_local,
                        std::vector<double>& ws_local, double t) {
    std::vector<double> xtemp_cpy(xs_local), ytemp_cpy(ys_local);
    std::vector<double> ws_temp_cpy(ws_local);
